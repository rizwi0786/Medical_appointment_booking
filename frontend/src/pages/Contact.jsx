    ...
    <section>
      <div className=" px-4 mx-auto max-w-screen-md ">
        ...
        <p className=" mb-8 lg:mb-16 font-light text-center text__para">
          Got any Technical Issue Lorem ipsum dolor sit amet consectetur adipisicing elit. Officia, cum!
        </p>
        <form action="#" className=' space-y-8'>
          ...
          <button className="btn rounded sm:w-fit" type="submit">Submit Feedback</button>
        </form>
      </div>
    </section>
  )
