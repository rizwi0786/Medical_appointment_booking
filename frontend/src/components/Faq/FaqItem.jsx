...
const FaqItem = ({item}) => {
    ...
    const toggleAccorion = ()=>{
        setIsOpen(!isOpen)
    };
  return (
    <div className="p-3 lg:p-5 roundded-[12px] border border-solid border-[#D9DCE3] mb-5 cursor-pointer
    ">
        <div className="flex items-center justify-between gap-5" onClick={toggleAccorion}>
